 ...
 */
@RequestMapping("/external/liferay/client")
@RestController
public class ExternalLiferayClientRestController extends BaseRestController {
		...
		if (_log.isInfoEnabled()) {
			_log.info(
				"There are " + messageBoardThreads.size() +
					" message board threads in the External Liferay site");
		}
	...
	private static final Log _log = LogFactory.getLog(
		ExternalLiferayClientRestController.class);
