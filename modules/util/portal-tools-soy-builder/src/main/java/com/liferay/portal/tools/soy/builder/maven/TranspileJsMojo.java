...
public class TranspileJsMojo extends BaseSoyNodeMojo<TranspileJsCommand> {
	 ...
	 *
	 * @parameter name="bundleFileName" default-value=""
	 */
	 ...
	 *
	 * @parameter name="format" default-value="amd"
	 */
	 ...
	 *
	 * @parameter name="globalName" default-value=""
	 */
	 ...
	 *
	 * @parameter name="moduleName" default-value=""
	 */
	 ...
	 *
	 * @parameter name="soySrcs" default-value="**\/*.soy"
	 */
	 ...
	 *
	 * @parameter name="srcs" default-value="**\/*.es.js, **\/*.soy.js"
	 */
