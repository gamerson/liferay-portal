...
public class WorkspaceExtension {
	...
	public WorkspaceExtension(Settings settings) {
		...
		String workspaceProductKey = _getProperty(
			settings, "product", (String)null);

		_productInfo = _getProductInfo(workspaceProductKey);
		...
		_liferayProductVersion = _getProperty(
			settings, "product.version", _getDefaultLiferayProductVersion());

		_releaseDate = _getProperty(
			settings, "release.date", _getDefaultReleaseDate());
	...
	public String getLiferayProductVersion() {
		return GradleUtil.toString(_liferayProductVersion);
	}
	...
	public String getReleaseDate() {
		return GradleUtil.toString(_releaseDate);
	}
	...
	private String _getDefaultLiferayProductVersion() {
		if (_productInfo != null) {
			return _productInfo.getLiferayProductVersion();
		}
	...
	private String _getDefaultReleaseDate() {
		if (_productInfo != null) {
			return _productInfo.getReleaseDate();
		}
