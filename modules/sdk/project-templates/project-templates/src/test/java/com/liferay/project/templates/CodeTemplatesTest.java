...
public class CodeTemplatesTest {
	...
	public void testGenerateCodeTemplateModelListener() throws Exception {
		...
		projectTemplatesArgs.setArchetypesDirs(Collections.singletonList(archetypesDir));
		...
		File modellistenerFile = new File(projectDir, "src/main/java/com/liferay/modellistener/FooModelListener.java");

		Assert.assertTrue(modellistenerFile.exists());

		_testContainsOrNot(projectDir, "src/main/java/com/liferay/modellistener/FooModelListener.java", false, true, "Layout");
	...
	public void testGenerateCodeTemplateRest() throws Exception {
		...
		File restFile = new File(projectDir, "src/main/java/com/liferay/rest/application/FooApplication.java");

		Assert.assertTrue(restFile.exists());

		_testContainsOrNot(projectDir, "src/main/java/com/liferay/rest/application/FooApplication.java", false, true, "fred");

		File modellistenerDir = new File(projectDir, "src/main/java/com/liferay/modellistener");
