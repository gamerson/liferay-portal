...
public class DependencyManagementTask extends DefaultTask {
	...
	@Option(
		description = "Set target file of saving target platform dependencyManagement.",
		option = "output-file"
	)
	...
	@Option(description = "Configures the output type.", option = "output-type")
			...
			if (_outputFile != null) {
				try {
					FileUtil.writeToFile(
						new File(_outputFile), dependenciesOutput);
				}
				catch (Exception e) {
