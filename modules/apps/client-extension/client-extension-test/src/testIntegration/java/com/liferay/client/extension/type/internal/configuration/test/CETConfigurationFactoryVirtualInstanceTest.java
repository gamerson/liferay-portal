...
public class CETConfigurationFactoryVirtualInstanceTest {
	...
	public static void setUpClass() throws Exception {
		...
		_autoCloseables.add(() -> _companyLocalService.deleteCompany(company));
	}
	...
	public void testDefault() throws Exception {
		String defaultFactoryConfigurationPid =
		...
		_autoCloseables.add(
			() -> ConfigurationTestUtil.deleteConfiguration(
				defaultFactoryConfigurationPid));
		...
		CET cet = _cetManager.getCET(
			company.getCompanyId(), "LXC:liferay-sample-iframe-2");

		Assert.assertNotNull(cet);

		Assert.assertEquals("Counter App", cet.getName());
	}
	...
	public void testVirtualHost() throws Exception {
		String virtualInstanceConfigurationPid =
			ConfigurationTestUtil.getFactoryConfiguration(
				"com.liferay.client.extension.type.configuration." +
					"CETConfiguration",
				"liferay-sample-iframe-3" + "/vi.localtest.me",
				HashMapDictionaryBuilder.<String, Object>put(
					"baseURL",
					...
					"webContextPath", "/liferay-sample-iframe-3_vi.localtest.me"
				).build());

		_autoCloseables.add(
			() -> ConfigurationTestUtil.deleteConfiguration(
				virtualInstanceConfigurationPid));
		...
		CET cet = _cetManager.getCET(
			company.getCompanyId(), "LXC:liferay-sample-iframe-3");

		Assert.assertNotNull(cet);

		Assert.assertEquals("Counter App vi.localtest.me", cet.getName());
	}
